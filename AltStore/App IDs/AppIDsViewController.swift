    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView
    {
        ...
        case UICollectionView.elementKindSectionHeader:
            ...
            if let activeTeam = DatabaseManager.shared.activeTeam(), activeTeam.type == .free
            {
                ...
                Each app and app extension installed with FluxStore must register an App ID with Apple. Apple limits non-developer Apple IDs to 10 App IDs at a time.

                **App IDs can't be deleted**, but they do expire after one week. FluxStore will automatically renew App IDs for all active apps once they've expired.
                """, comment: "")
            ...
            else
            {
                ...
                Each app and app extension installed with FluxStore must register an App ID with Apple.
