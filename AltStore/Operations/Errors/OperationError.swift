...
struct OperationError: ALTLocalizedError {
    ...
    var errorFailureReason: String {
        ...
        case .unknownUDID: return NSLocalizedString("aerostore could not determine this device's UDID. Please replace your pairing using iloader.", comment: "")
        ...
        case .noSources: return NSLocalizedString("There are no aerostore sources.", comment: "")
        case .missingAppGroup: return NSLocalizedString("aerostore's shared app group could not be accessed.", comment: "")
        case .forbidden:
        ...
        case .sourceNotAdded:
            ...
            return String(format: NSLocalizedString("%@ is not added to aerostore.", comment: ""), sourceName)
        ...
        case .openAppFailed:
            let appName = self.appName ?? NSLocalizedString("The app", comment: "")
            return String(format: NSLocalizedString("aerostore was denied permission to launch %@.", comment: ""), appName)
        case .noWiFi: return NSLocalizedString("You do not appear to be connected to Wi-Fi and/or LocalDevVPN!\naerostore cannot install or refresh applications without Wi-Fi and LocalDevVPN. If both are connected, replace your pairing with iloader.", comment: "")
        case .tooNewError: return NSLocalizedString("iOS 17.0-17.3.1 changed how JIT is enabled so aerostore cannot enable JIT without SideJITServer on these versions, sorry for any inconvenience.", comment: "")
