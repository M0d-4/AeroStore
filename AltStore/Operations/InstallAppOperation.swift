                ...
                DispatchQueue.main.asyncAfter(deadline: .now() + 3) {
                    ...
                    UNUserNotificationCenter.current().getNotificationSettings { settings in
                        ...
                        default:
                            ...
                            let alert = UIAlertController(title: "Finish Refresh", message: "Please reopen aerostore after the process is finished.To finish refreshing, aerostore must be moved to the background. To do this, you can either go to the Home Screen manually or by hitting Continue. Please reopen aerostore after doing this.", preferredStyle: .alert)
