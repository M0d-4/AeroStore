                ...
                DispatchQueue.main.asyncAfter(deadline: .now() + 3) {
                    ...
                    UNUserNotificationCenter.current().getNotificationSettings { settings in
                        ...
                        case .authorized, .ephemeral, .provisional:
                            ...
                            content.body = "FluxStore will automatically move to the homescreen to finish refreshing!"
                        ...
                        default:
                            ...
                            let alert = UIAlertController(title: "Finish Refresh", message: "Please reopen FluxStore after the process is finished.To finish refreshing, FluxStore must be moved to the background. To do this, you can either go to the Home Screen manually or by hitting Continue. Please reopen FluxStore after doing this.", preferredStyle: .alert)
